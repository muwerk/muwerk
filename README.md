...
file system (if available) and statistical information. See the [mu_console](https://github.com/muwerk/muwerk/blob/master/Examples/console/mu_console.cpp) example
